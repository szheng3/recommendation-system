...
|   |   `-- RR_SNQN_Recommender.ipynb          --- Run SNQN +/- CQL on RR
|   |-- Data
|   |   |-- HM_data
|   |   |   `-- README.md
|   |   `-- RR_data
...
|   |   |-- data
|   |   |   |-- category_item.csv
|   |   |   `-- rc_item_features.csv    --- Generatad from EDA_RetailRocket.ipynb   
|   |   `-- src
|   |       |-- DQN_NS.py
|   |       |-- NextItNetModules.py
|   |       |-- SA2C.py
